...
const regionalOpportunities = [
  { region: "Northwest region", position: "northwest", counties: "Woodward, Woods, Harper", focus: "Agriculture, processing, and regional facilities" },
        ...
        <div className="cornerstone-intelligence cornerstone-intelligence--network">
          <Reveal className="cornerstone-map-panel">
            ...
            <div className="cornerstone-map cornerstone-map--network">
              ...
              {regionalOpportunities.map(({ region, position, counties, focus }) => (
                <button className={`cornerstone-project-pin cornerstone-project-pin--${position}`} type="button" aria-label={`Illustrative ${region} opportunity near ${counties} counties`} key={region}>
                  <i aria-hidden="true" />
                  <span className="cornerstone-project-popover">
                    <small>Illustrative opportunity</small>
                    <strong>{region}</strong>
                    <span><b>County cluster</b>{counties}</span>
                    <span><b>Evaluation focus</b>{focus}</span>
                    <em>No project announced</em>
                  </span>
                </button>
              ))}
            </div>
