...
export default function TermsPage() {
  return (
    <LegalShell eyebrow="NSoul LLC" title="Terms of Use" updated="August 4, 2026">
      ...
      <section><h2>Submissions</h2><p>Submitting a commercial inquiry, energy assessment, diligence request, property, document, or message does not create an agency, partnership, customer relationship, offer, site approval, development commitment, confidentiality obligation, or agreement. Diligence requests do not grant access to private files. Final obligations exist only in executed documents signed by authorized parties.</p></section>
