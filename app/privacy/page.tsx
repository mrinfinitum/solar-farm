...
export default function PrivacyPage() {
  return (
    <LegalShell eyebrow="NSoul LLC" title="Privacy Policy" updated="August 4, 2026">
      ...
      <section><h2>Information you provide</h2><p>Commercial inquiry and energy-assessment data may include your name, work contact information, company, job title, facility location, energy profile, utility provider, desired timeline, utility statements, and message. Diligence access requests may include your professional role, project relationship, requested documents, and NDA willingness. Land submissions may include ownership or broker details, property location, acreage, land characteristics, transaction preferences, listing or parcel information, and an optional supporting file.</p></section>
