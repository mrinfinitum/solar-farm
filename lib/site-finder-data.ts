...
export async function getProperties(options?: { search?: string; stage?: string; status?: string; county?: string; grade?: string; risk?: string; confidence?: string; assignedTo?: string; utility?: string; verified?: string; sort?: string; page?: number; pageSize?: number }) {
